...
limpia_dir <- function(x){
  ...
  # into "o", the pattern no longer matches and "NO 799" stays glued to the
  # street name. Same handling as section 2.
  s0 <- as.character(x)
...
# still move coordinates, so anything derived from them at this point would be
# out of date; section 1 of 08_station_variables.R computes it once the
